...
class Request
{
    ...
    public function __construct(\Kemonai\Zigatext $zigatextObj = null)
    {
        $this->response = new Response();
        $this->response->setRequestObject($this);
        $this->zigatextObj = $zigatextObj;
        $this->response->forApi = !is_null($zigatextObj);
    ...
    {
        if (isset($this->zigatextObj) && !$this->zigatextObj->use_guzzle) {
    ...
    {
        if (!Zigatext::$fallback_to_file_get_contents) {
            return;
        }
