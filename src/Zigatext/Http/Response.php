...
use \Kemonai\Zigatext\Exception\ApiException;
...
class Response
{
    ...
    public function wrapUp()
    {
        if ($this->okay && $this->forApi) {
            return $this->parseZigatextResponse();
        }
        if (!$this->okay && $this->forApi) {
